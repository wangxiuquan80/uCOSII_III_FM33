...
#define  BSP_GPIOC_LED1                        DEF_BIT_12       /* LED 1-3 controlled by GPIOC                          */
#define  BSP_GPIOC_LED2                        DEF_BIT_13
#define  BSP_GPIOC_LED3                        DEF_BIT_14
#define  BSP_GPIOD_LED4                        DEF_BIT_07       /* LED 4 controlled by GPIOD                            */
...
static void  BSP_LED_Init()
{
    ...
    gpio_init.Pin   = BSP_GPIOC_LED1 | BSP_GPIOC_LED2 | BSP_GPIOC_LED3;
    gpio_init.PxFCR  = GPIO_FCR_OUT;
    GPIO_Init(GPIOC, &gpio_init);
    gpio_init.Pin = BSP_GPIOD_LED4;
